...
## Tasks
- [ ] L1. MiniPlayer rebuild scoping (widgets/mini_player.dart): today TWO
      ...
      result here.
- [ ] L2. Sleep-timer full-screen rebuild (screens/player_screen.dart:105-110):
...
- [ ] L3. Search debounce (~150 ms) in library_screen search field (:759-797):
...
- [ ] L4. Persist view mode: promote private _ViewMode to models/ (or reuse
...
- [ ] L5. Enrichment default mismatch: onboarding_screen.dart checkbox defaults
      ...
      note result.
- [ ] L6. Dead ternary cleanup player_screen.dart:627-629 (both arms identical)
      — delete, keep single expression.
- [ ] L7. Gate green. Commits: `perf(mini-player): scope position rebuilds`,
